// Course schedule for the Training page.
// org: 'GUE' courses link to GUE.com; others (TDI samples) open the enquiry popup.
// TDI rows are placeholder samples for visual reference until real scheduling is wired.
export const courses = [
  { course: 'GUE Technical Fundamentals', date: 'May 25, 2026', instructor: 'Imad Farhat',     org: 'GUE', level: 'Fundamentals', gueUrl: 'https://www.gue.com/diver-training/gue-class-schedule', details: 'The cornerstone GUE course — buoyancy, trim, propulsion, and team skills that underpin every dive that follows.' },
  { course: 'GUE Cave Diver 1',            date: 'May 24, 2026', instructor: 'Per Normark',     org: 'GUE', level: 'Cave',         gueUrl: 'https://www.gue.com/diver-training/gue-class-schedule', details: 'Your first overhead-environment certification in real Sardinian cave systems.' },
  { course: 'GUE CCR Technical Diver 1',   date: 'Jun 8, 2026',  instructor: 'JP Bresser',      org: 'GUE', level: 'CCR',          gueUrl: 'https://www.gue.com/diver-training/gue-class-schedule', details: 'Closed-circuit rebreather diving for extended-range technical and cave dives.' },
